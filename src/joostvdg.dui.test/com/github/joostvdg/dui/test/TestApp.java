...
public class TestApp {
    public static void main(String[] args) {
        ...
        DuiServer serverSimple = DuiServerFactory.newServerSimple(ProtocolConstants.EXTERNAL_COMMUNICATION_PORT_A, ProtocolConstants.POTENTIAL_SERVER_NAMES[pseudoRandom], logger);
